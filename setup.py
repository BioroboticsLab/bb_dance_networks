...
setup(
    name="bb_dance_networks",
    version="0.1",
    description="BeesBook dance and follower trajectory recognition.",
    author="David Dormagen",
    author_email="david.dormagen@fu-berlin.de",
    url="https://github.com/BioroboticsLab/bb_dance_networks/",
    install_requires=reqs,
    dependency_links=dep_links,
    packages=find_packages(),
    package_dir={"bb_dance_networks": "bb_dance_networks/"},
)
